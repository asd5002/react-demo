...
function code(deps) {
  ...
  return function (_Component) {
    ...
    function Code() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Code.__proto__ || Object.getPrototypeOf(Code)).call.apply(_ref, [this].concat(args))), _this), _this.parseJSON = function () {
