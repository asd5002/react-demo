...
function samp(deps) {
  ...
  return function (_Component) {
    ...
    function Samp() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Samp.__proto__ || Object.getPrototypeOf(Samp)).call.apply(_ref, [this].concat(args))), _this), _this.parseJSON = function () {
